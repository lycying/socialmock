...
public class ExpressionUtil {
	...
	public static void dealExpression(Context context,SpannableString spannableString, Pattern patten)throws SecurityException, NoSuchFieldException, NumberFormatException, IllegalArgumentException, IllegalAccessException {
	...
	public static SpannableString getExpressionString(Context context, String str) {
		if(null==str || "".equals(str)) return new SpannableString("");
